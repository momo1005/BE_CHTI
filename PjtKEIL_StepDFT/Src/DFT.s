	...
	;import LeSignal; -> sinon soucis prend pas la bonne adresse dans r0 jsp pourquoi.
...
; écrire le code ici		
;int DFT_ModuleAuCarre(short int * signal64 ech, char k);
; 2 parametre d'entrée -> R0 et R1
; un parametre de sortie -> R0

DFT_ModuleAuCarre proc
	push {r4-r10,lr}
	;ETAPE 1 -  Remonter la partie réelle
	;on utilise le tableau de cosinus
	
	;r0 on a le singal -> ADRESSE du tableau de valeur du signal
	;r1 -> k
...
DEBUTFOR
	;recuperer les element du tableau
	;les convertir en forme fractionnaire
	;les sommer
